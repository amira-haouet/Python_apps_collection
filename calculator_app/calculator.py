...
def cal():
    ...
    color_button = '#0099FF'
    num_button_color = '#4B4B4B'
    other_button_bg = '#DDDDDD'
    text_fg = '#FFFFFF'
    button_active_bg = '#C0C0C0'

    num_button = partial(Button, root, fg=text_fg, bg=num_button_color,
                         padx=10, pady=3, activebackground=button_active_bg)
    cal_button = partial(Button, root, fg=text_fg, bg=color_button,
                         padx=10, pady=3, activebackground=button_active_bg)
    ...
    button7 = num_button(text='7', bg=num_button_color,command=lambda: get_input(entry, '7'))
    ...
    button14 = Button(root, text='/', fg=text_fg, bg=color_button, padx=10, pady=3,
    ...
    button17 = Button(root, text='=', fg=text_fg, bg='green', padx=10, pady=3,
                      command=lambda: calc(entry), activebackground=button_active_bg)
    button17.grid(row=5, column=3, pady=5)

    button18 = Button(root, text='^', fg=text_fg, bg=color_button, padx=10, pady=3,
                      command=lambda: get_input(entry, '**'))
    ...
    exit = Button(root, text='Quit', fg='white', bg='red', command=quit, height=1, width=7)
